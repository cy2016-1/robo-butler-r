...
void force_control_and_dis_pose(float dt)//底层==>位力混控制  站立步态！！
{
    ...
    if(robotwb.state_gait==2){
        ...
        robotwb.arm_epos_h_exp_flt.x+=LIMIT(robotwb.arm_epos_h_exp.x-robotwb.arm_epos_h_exp_flt.x,-0.1,0.1)*kp_gain[0];
        robotwb.arm_epos_h_exp_flt.y+=LIMIT(robotwb.arm_epos_h_exp.y-robotwb.arm_epos_h_exp_flt.y,-0.1,0.1)*kp_gain[0];
        robotwb.arm_epos_h_exp_flt.z+=LIMIT(robotwb.arm_epos_h_exp.z-robotwb.arm_epos_h_exp_flt.z,-0.1,0.1)*kp_gain[0];
